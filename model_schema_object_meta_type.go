...
// checks if the SchemaObjectMetaType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SchemaObjectMetaType{}

// SchemaObjectMetaType ObjectMetaType is metadata(common attributes) of an object that all configuration objects will have. The information in this type can be specified by user during create and replace APIs.
type SchemaObjectMetaType struct {
	...
	//  uid is the unique in time and space value for this object. Object create will fail if  provided by the client and the value exists in the system. Typically generated by the  server on successful creation of an object and is not allowed to change once populated.  Shadowed by SystemObjectMeta's uid field.  Example: ` \"d15f1fad-4d37-48c0-8706-df1824d76d31\"`
...
func (o SchemaObjectMetaType) MarshalJSON() ([]byte, error) {
...
func (o SchemaObjectMetaType) ToMap() (map[string]interface{}, error) {
...
type NullableSchemaObjectMetaType struct {
	value *SchemaObjectMetaType
	isSet bool
}

func (v NullableSchemaObjectMetaType) Get() *SchemaObjectMetaType {
	return v.value
}

func (v *NullableSchemaObjectMetaType) Set(val *SchemaObjectMetaType) {
	v.value = val
	v.isSet = true
}

func (v NullableSchemaObjectMetaType) IsSet() bool {
	return v.isSet
}

func (v *NullableSchemaObjectMetaType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchemaObjectMetaType(val *SchemaObjectMetaType) *NullableSchemaObjectMetaType {
	return &NullableSchemaObjectMetaType{value: val, isSet: true}
}

func (v NullableSchemaObjectMetaType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchemaObjectMetaType) UnmarshalJSON(src []byte) error {
	v.isSet = true
